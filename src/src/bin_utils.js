...
const fileSignatures = [
	...
	/* 4B offset */ {
		ext: 'heif',
		sig: [0x00, 0x00, 0x00, 0x18, 0x66, 0x74, 0x79, 0x70, 0x68, 0x65, 0x69, 0x63],
	},
	/* 4B offset */ { ext: 'mp4', sig: [0x66, 0x74, 0x79, 0x70, 0x69, 0x73, 0x6f, 0x6d] },
	/* 4B offset */ { ext: 'mov', sig: [0x66, 0x74, 0x79, 0x70, 0x71, 0x74, 0x20, 0x20] },
	/* 4B offset */ { ext: 'mov', sig: [0x6d, 0x6f, 0x6f, 0x76] },
	/* 4B offset */ { ext: 'avif', sig: [0x66, 0x74, 0x79, 0x70, 0x61, 0x76, 0x69, 0x66] },
	// { ext: 'tar', sig: [] },
];
